...
export default async function TodosTable({ search, currentPage, items_per_page, category: category_filter, reverse }: { search: string; currentPage: number; items_per_page: number; category?: number; reverse: boolean }) {
